export const translations = {
  en: {
    ...
    broadcast: 'Broadcast',
    broadcastSlave: 'Broadcast (Slave 0)',
    broadcastHint: 'Slave ID 0 broadcasts to all devices. Write-only, no response is returned.',
    ...
    actions: 'Actions',
    count: 'Count',
    memoryConfiguration: 'Device Image',
    memoryConfigurationHint: 'Initial capacity of the per-connection register image (in registers). If the device responds beyond this range the buffer grows automatically — data is never dropped.',
  ...
  zh: {
    ...
    connecting: '连接中...',
    broadcast: '广播',
    broadcastSlave: '广播 (从站 0)',
    broadcastHint: '从站地址 0 表示向所有设备广播，仅支持写操作，无响应返回。',
    ...
    memoryConfigurationHint: '每连接寄存器镜像的初始容量（单位：寄存器）。设备响应超出该范围时缓冲区会自动扩容，不会丢数据。',
