export const translations = {
  en: {
    ...
    deviceImageHint: 'Initial capacity of the per-connection register image (in registers). If the device responds beyond this range the buffer grows automatically — data is never dropped.',
  ...
  zh: {
    ...
    count: '数量',
    deviceImage: '设备镜像',
    deviceImageHint: '每连接寄存器镜像的初始容量（单位：寄存器）。设备响应超出该范围时缓冲区会自动扩容，不会丢数据。',
